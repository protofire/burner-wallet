...
export default class Advanced extends React.Component {
  ...
  render() {
    let { mainStyle, web3, vendors, dollarDisplay, vendorObject } = this.props
        ...
        if (prod.exists && prod.isAvailable) {
              ...
              <div className="main-card card w-100" style={{ paddingTop: 40 }} onClick={toggleQR}>
                <div className="content qr row">
                  ...
                  <div style={{ width: '100%', textAlign: 'center' }}>
                    <div>{correctVendorObject.name}</div> {theName}: {dollarDisplay(theAmount)}
                  </div>
                </div>
              </div>
            )
          ...
          products.push(
            <div
              ...
              style={{ borderBottom: '1px solid #dddddd', paddingTop: 15, paddingBottom: 10 }}
            >
              ...
              <div className="col-4 p-1">
                <button
                  ...
                  style={{ backgroundColor: mainStyle.mainColor, whiteSpace: 'nowrap', marginTop: -8 }}
                  onClick={() => {
                ...
                >
                  <Scaler config={{ startZoomAt: 500, origin: '40% 50%' }}>Purchase</Scaler>
                </button>
              </div>
              {extraQR}
            </div>
