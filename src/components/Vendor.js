    ...
    for (let p in this.props.products) {
      ...
      if (prod.exists) {
        ...
        if (this.state.changingAvailable[p]) {
          ...
          productAvailableDisplay = <i className="fas fa-eye"></i>
        } else {
          productAvailableDisplay = <i className="fas fa-eye-slash"></i>
        }
        ...
        products.push(
          <div key={p} className="content bridge row" style={{ opacity }}>
            ...
            <div className="col-4 p-1">{dollarDisplay(web3.utils.fromWei(prod.cost, 'ether'))}</div>
      ...
      <div className="main-card card w-100">
        <div className="content bridge row">
          ...
          <div className="col-4 p-1">
            ...
            >
              <Scaler config={{ startZoomAt: 500, origin: '40% 50%' }}>{venderButtonText}</Scaler>
            </button>
          </div>
        </div>
        {products}
        <div className="content bridge row">
          ...
          <div className="col-4 p-1">
            ...
            >
              <Scaler config={{ startZoomAt: 650, origin: '20% 50%' }}>{addProductText}</Scaler>
            </button>
          </div>
        </div>
      </div>
