...
export default class Exchange extends React.Component {
          ...
          <button
            ...
            onClick={() => {
              if (this.state.gettingGas) {
                ...
                axios
                  .get('https://ethgasstation.info/json/ethgasAPI.json', { crossdomain: true })
                  .catch(err => {
                      ...
                      if (gasEmitterContract) {
                        ...
                        if (this.state.xdaiMetaAccount) {
                          ...
                          this.state.xdaiweb3.eth.accounts
                            .signTransaction(paramsObject, this.state.xdaiMetaAccount.privateKey)
                            .then(signed => {
  ...
  sendDai() {
    if (parseFloat(this.props.daiBalance) < parseFloat(this.state.daiSendAmount)) {
      ...
      this.transferDai(
        ...
        'Sending ' + this.state.daiSendAmount + ' DAI to ' + this.state.daiSendToAddress + '...',
        () => {
          this.props.changeAlert({
            type: 'success',
            message: 'Sent ' + this.state.daiSendAmount + ' DAI to ' + this.state.daiSendToAddress
          })
          this.setState({
            daiToXdaiMode: false,
            daiSendAmount: '',
        ...
        if (response && response.data.average > 0 && response.data.average < 200) {
          ...
          if (this.state.mainnetMetaAccount) {
            ...
            paramsObject.data = this.props.daiContract.methods
              .transfer(destination, this.state.mainnetweb3.utils.toWei('' + amount, 'ether'))
              .encodeABI()
  ...
  canSendXdai() {
    ...
    return (
      ...
      parseFloat(this.state.xdaiSendAmount) <= parseFloat(this.props.xdaiBalance)
    )
  }
  ...
  sendEth() {
    ...
    if (parseFloat(this.props.ethBalance) < actualEthSendAmount) {
      ...
      this.transferEth(
        ...
        false,
        actualEthSendAmount,
        'Sending $' + this.state.ethSendAmount + ' of ETH to ' + this.state.ethSendToAddress + '...',
        () => {
          this.props.changeAlert({
            type: 'success',
            message: 'Sent $' + this.state.ethSendAmount + ' of ETH to ' + this.state.ethSendToAddress
          })
          this.setState({
            ethToDaiMode: false,
            ethSendAmount: '',
          ...
          xdaiToDendaiDisplay = (
            <div className="content ops row">
              ...
              <div className="col-3 p-1" style={colStyle}>
                <Scaler config={{ startZoomAt: 650, origin: '0% 85%' }}>{xdaiCancelButton}</Scaler>
              </div>
                ...
                <div className="col-3 p-1">
                  <button
                    ...
                    onClick={async () => {
                      ...
                      console.log(
                        'Using ' + this.props.ERC20NAME + ' contract to withdraw ' + amountOfxDaiToWithdraw + ' xDai'
                      )
        ...
        daiToXdaiDisplay = (
          <div className="content ops row">
            ...
            <div className="col-2 p-1" style={colStyle}>
              <Scaler config={{ startZoomAt: 650, origin: '0% 85%' }}>{daiCancelButton}</Scaler>
            </div>
            <div className="col-3 p-1">
              <button
                className="btn btn-large w-100"
      ...
      if (!this.state.mainnetMetaAccount && this.props.network != 'Mainnet') {
        ...
        ethToDaiDisplay = (
          <div className="content ops row">
                      ...
                      axios
                        ...
                        .then(response => {
                          if (response && response.data.average > 0 && response.data.average < 200) {
                            ...
                            this.setState(
                              { amount: Math.floor(this.props.ethprice * adjustedEthBalance * 100) / 100 },
                              () => {
                                this.setState({
                                  canSendDai: this.canSendDai(),
                                  canSendEth: this.canSendEth(),
            ...
            <div className="col-2 p-1" style={colStyle}>
              <Scaler config={{ startZoomAt: 650, origin: '0% 85%' }}>{ethCancelButton}</Scaler>
            </div>
            <div className="col-3 p-1">
              <button
                className="btn btn-large w-100"
                                  ...
                                  .on('receipt', async receipt => {
                                    ...
                                    if (
                                      ...
                                      paramsObject.data = uniswapContract.methods
                                        .tokenToEthSwapInput('' + amountOfDai, '' + mineth, '' + deadline)
                                        .encodeABI()
          ...
          <div className="content ops row">
            <div className="form-group w-100">
              ...
              <button
                style={this.props.buttonStyle.primary}
                disabled={buttonsDisabled}
                className={`btn btn-success btn-lg w-100 ${this.state.canSendDai ? '' : 'disabled'}`}
    ...
    let fundByWyreButton = (
      <button
        ...
        onClick={() => {
          ...
          Wyre.displayWidget(this.props.address, this.state.wyreFundAmount, () => {
          ...
          <div className="content ops row">
            <div className="form-group w-100">
                    ...
                    axios
                      ...
                      .then(response => {
                        if (response && response.data.average > 0 && response.data.average < 200) {
                          ...
                          this.setState(
                            { ethSendAmount: Math.floor(this.props.ethprice * adjustedEthBalance * 100) / 100 },
                            () => {
                              this.setState({
                                canSendDai: this.canSendDai(),
                                canSendEth: this.canSendEth(),
              ...
              <button
                style={this.props.buttonStyle.primary}
                disabled={buttonsDisabled}
                className={`btn btn-success btn-lg w-100 ${this.state.canSendEth ? '' : 'disabled'}`}
          ...
          <div className="content ops row">
            <div className="form-group w-100">
              ...
              <button
                style={this.props.buttonStyle.primary}
                disabled={buttonsDisabled}
                className={`btn btn-success btn-lg w-100 ${this.state.canSendXdai ? '' : 'disabled'}`}
              ...
              <div className="col-5 p-1" style={{ whiteSpace: 'nowrap' }}>
                ...
                >
                  <InputRange
                    ...
                    step={1}
                    onChange={value => this.updateState('wyreFundAmount', value)}
                  />
                </div>
              </div>
              <div className="col-3 p-1" style={{ marginTop: 8 }}>
