  ...
  render() {
    ...
    for (let r in theseTransactionsByAddress) {
      ...
      if (theseTransactionsByAddress[r].encrypted) {
        isEncrypted = <i className="fa fa-lock" style={{ fontSize: 12, opacity: 0.8 }} aria-hidden="true"></i>
      }
          ...
          txns.push(
            <div style={{ paddingTop: 10, paddingBottom: 10 }}>
              ...
              <div className="content ops row" style={{ position: 'relative' }}>
                ...
                <div
                  className="chat"
                  style={{ position: 'relative', marginLeft: 32, marginTop: 3, textAlign: 'left', width: '100%' }}
                >
                  <Linkify properties={{ target: '_blank' }}>{emojiText}</Linkify>
                </div>
                {messageValue}
              </div>
            </div>
          ...
          txns.push(
            <div key={'tx' + r} style={{ paddingTop: 3, paddingBottom: 21 }}>
              ...
              <div className="content ops row" style={{ position: 'relative', paddingTop: 3 }}>
                ...
                <div style={{ color: '#000000', width: '100%', marginTop: -2 }}>{messageValue}</div>
                <div style={{ position: 'absolute', left: 0 }}>
                  <Blockies seed={theseTransactionsByAddress[r].from} scale={3} />
                </div>
              </div>
          ...
          txns.push(
            <div key={'tx' + r} style={{ paddingTop: 10, paddingBottom: 10 }}>
              ...
              <div className="content ops row" style={{ position: 'relative' }}>
                ...
                <div
                  className="chat"
                  style={{ position: 'relative', marginRight: 32, marginTop: 3, textAlign: 'right', width: '100%' }}
                >
                  <Linkify properties={{ target: '_blank' }}>{emojiText}</Linkify>
                </div>
                {messageValue}
    ...
    if (this.state.sendingChat) {
      ...
      sendChatButton = (
        <button className="btn btn-large w-100" style={buttonStyle.primary} onClick={this.sendChat.bind(this)}>
          <Scaler config={{ startZoomAt: 400, origin: '50% 50%' }}>
      ...
      sendFundsButton = (
        <button className="btn btn-large w-100" style={buttonStyle.secondary} onClick={this.sendChat.bind(this)}>
          <Scaler config={{ startZoomAt: 400, origin: '50% 50%' }}>
            <i className="fas fa-comment" />
          </Scaler>
        </button>
    ...
    if (this.state['publicKey_' + target]) {
      isEncrypted = (
        <i
          ...
          style={{ fontSize: 30, opacity: 0.8, position: 'absolute', left: 50, top: 10 }}
          aria-hidden="true"
        ></i>
      )
    }
